...
public class Quotestable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Quotestable frame = new Quotestable();
	...
	public Quotestable() {
		...
		lblQuotes.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		lblQuotes.setBounds(179, 24, 90, 20);
		...
		btnDelete.setBounds(161, 207, 89, 23);
